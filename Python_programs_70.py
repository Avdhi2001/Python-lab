...
Please Enter First String : avdhi
Please Enter Second String : pagaria
Your first string has become :- pvdhi
Your second string has become :-  aagaria
...
print(get_max_occuring_char("Avdhi"))
o
A
...
print(capitalize_first_last_letters("Avdhi"))
AcropoliS
ShrutI
